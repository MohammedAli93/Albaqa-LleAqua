  ...
  return (
    <>
      ...
      <p className="mt-6 text-center text-sm leading-relaxed text-desert-ink/50">
        تُضاف الباقة إلى رصيد حسابك فور إتمام الدفع، وتُستخدم اللعبة الواحدة لبدء مباراة كاملة بالنظام الذي تختاره، وفق عدد الجولات الخاص بكل نظام، مع إمكانية اختيار الفئات.
      </p>
